...
def string_to_coordinates_tuple(
    ...
    try:
        ...
        # Basic validation: latitude should be between -90 and 90,
...
def filter_out_profiles_outside_range(
    ...
    profile_coords = string_to_coordinates_tuple(
        current_profile.current_coordinates
    )
    ...
    for user in map_profiles:
        ...
        user_coords = string_to_coordinates_tuple(
