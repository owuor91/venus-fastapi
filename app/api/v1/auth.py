...
def register(user_data: RegisterRequest, db: Session = Depends(get_db)):
    ...
    db_user = User(
        ...
        # Set to user's email for first registration
...
def login(login_data: LoginRequest, db: Session = Depends(get_db)):
    ...
    Returns: token, user details (user_id, first_name, last_name, email),
    and profile (null if not present)
    """
...
def complete_profile(
    ...
    if existing_profile:
        ...
        existing_profile.gender = profile_data.gender.value
        ...
        existing_profile.updated_by = str(current_user.user_id)
